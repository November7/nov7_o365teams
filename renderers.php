...
class theme_nov7_o365teams_mod_assign_renderer extends mod_assign_renderer {
    /**
     * Render the header.
     *
...
class theme_nov7_o365teams_core_course_renderer extends core_course_renderer {
...
class theme_nov7_o365teams_mod_quiz_renderer extends mod_quiz_renderer {
    /**
    ...
    protected function attempt_navigation_buttons_with_link($page, $lastpage, $navmethod = 'free', $viewurl = null) {
        ...
        if ($viewurl) {
            // Return button.
            $output .= html_writer::link($viewurl, get_string('navigatereturn', 'theme_nov7_o365teams'),
